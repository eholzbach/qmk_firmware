...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |Ctrl|Alt |Gui |      Space            |FN |Alt |Menu |Ctrl |
   * `-----------------------------------------------------------'
   */
[_BL] = LAYOUT_60_ansi(
  ...
  KC_LCTL, KC_LALT,KC_LGUI,                KC_SPC,                                 MO(_FL),KC_RALT, KC_MENU,KC_RCTL),
...
[_FL] = LAYOUT_60_ansi(
  ...
  MO(_CL),  _______, _______,                            _______,                            _______, KC_LEFT, KC_DOWN, KC_RGHT),
...
[_CL] = LAYOUT_60_ansi(
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_PGUP, _______, _______, _______,           _______ , \
